...
class Assets extends compose(null, {base: ''}, importer, path) {
  /* NOTE
  - 'Assets' deliberatly provides an API similar to 'Loaders' and does share 
    some code. However, 'Loaders' is much more critical than 'Assets'. 
    Code-sharing and attempts converge the APIs should therefore never get in 
    the way of optimizing 'Loaders'. */
